...
public class XMLParser {
        ...
        try{
            ...
            try {
                for(Student id : orders) {
                    element.appendChild(getStudent(document, id.getStudentFirstName(),
                                                             id.getStudentLastName(),
                                                             id.getStudentAmount().toString(),
                                                             id.getStudentID(),
                                                                id.getFileName())
                    );
    ...
    private static Node getStudent(Document doc, String FirstName, String SecondName, String srAmount, String ID, String filename) {
        ...
        student.appendChild(getStudentElements(doc, student, "FileName", filename));
